...
## Entscheidung
- **Druck:** Unter jedem Kapitel „Siehe auch: Kapitel 4 „…“; Kapitel 7 „…““ – mit Kapitelnummer des gedruckten Handbuchs und Sprungmarke (im PDF anklickbar). Es zählen nur Kapitel, die mitgedruckt werden. Passende FAQ der gedruckten Kapitel erscheinen gesammelt im Anhang **„Häufige Fragen“** (im Inhaltsverzeichnis). Ein Abruf für alle Kapitel: `GET /reader/related` (Map chapterId → Verweise, FAQ). Die Druckansicht wartet darauf, bevor „Drucken“ möglich ist.
