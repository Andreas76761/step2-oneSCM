...
- Der **erste Wunsch** je Kapitel und Sprache erzeugt einen Hinweis in der Kapitel-Diskussion an Autorin/Autor und Einreichende der neuesten Fassung (wie Leser-Rückmeldungen, ADR-061) – ohne Flut bei vielen Wünschen. „Erster“ entscheidet das atomare Einfügen einer Zeile in `translation_request_notices` (Primärschlüssel Kapitel + Sprache), damit gleichzeitige Wünsche verschiedener Personen nur einen Hinweis erzeugen.
