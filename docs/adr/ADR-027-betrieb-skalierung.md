...
- **Migrationen bei mehreren Replikaten:** PostgreSQL führt Migrationen unter einer Sitzungssperre (`pg_advisory_lock`) aus – gleichzeitig startende Instanzen warten aufeinander (Test T-151).
