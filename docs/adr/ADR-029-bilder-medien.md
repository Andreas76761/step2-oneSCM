...
- **Nur Rasterformate** PNG, JPEG, GIF, WebP – erkannt an der Dateisignatur, nicht an der Endung. SVG war ausgeschlossen (Skripte); seit Etappe 12 wird SVG bereinigt neu geschrieben (ADR-036). Abmessungen werden aus dem Dateikopf gelesen.
