...
| 4 | P2: Vergleich ganzer Kapitelversionen (US-019); S3-kompatibler Object-Store für Mehrinstanzbetrieb; optional LLM-Umformulierung (ADR-007) mit Quellenbindung je Satz | |
