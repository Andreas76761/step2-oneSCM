...
| **20** ✅ | Rückmeldungen auswerten (ADR-058); eigene Kapitelvorlagen (ADR-059); Druck-/PDF-Ansicht (ADR-060); Rückmeldungen in der Online-Hilfe (ADR-061) | 103 Server- und 69 E2E-Tests grün auf SQLite und PostgreSQL |
