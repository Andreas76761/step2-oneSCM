...
| **22** ✅ | Druck je Variante und Rolle im Firmen-Layout (ADR-065); Suche und Glossar beim Lesen (ADR-066); Vorlagen duplizieren, exportieren, importieren (ADR-067) | 107 Server- und 73 E2E-Tests grün auf SQLite und PostgreSQL |
