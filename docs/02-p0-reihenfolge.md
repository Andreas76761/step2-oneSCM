...
| **4** ✅ | P2: Vergleich ganzer Kapitelversionen (US-019); S3-kompatibler Object-Store für Mehrinstanzbetrieb | 36 Server- und 4 E2E-Tests grün auf SQLite und PostgreSQL; S3 gegen s3rver/MinIO |
